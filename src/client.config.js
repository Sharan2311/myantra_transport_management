...
const CLIENT_CONFIG = {
  ...
  supabaseUrl:       "https://thowscasaacsuzplqjfd.supabase.co",  // filled from supabase.js env vars for now
  supabaseAnonKey:   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRob3dzY2FzYWFjc3V6cGxxamZkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc5MjMyMDYsImV4cCI6MjA5MzQ5OTIwNn0.0T9BdbInnaPjsatO7CoEbYQg_EzLycrYajEqbrRxj_8",  // filled from supabase.js env vars for now
